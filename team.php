...
<div class="container-fluid py-5">
    <div class="container">
        <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
            <h2 class="text-primary font-secondary">Master Chefs</h2>
            <h1 class="display-4 text-uppercase">Our Coffee Specialists</h1>
        </div>
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="team-item">
                    ...
                    <div class="bg-dark border-inner text-center p-4">
                        <h4 class="text-uppercase text-primary">Mr.Kumara</h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item">
                    ...
                    <div class="bg-dark border-inner text-center p-4">
                        <h4 class="text-uppercase text-primary">Mr.Saman</h4>
                        <p class="text-white m-0">Barista</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="team-item">
                    ...
                    <div class="bg-dark border-inner text-center p-4">
                        <h4 class="text-uppercase text-primary">Mr.Silva</h4>
                        <p class="text-white m-0">Barista</p>
                    </div>
                </div>
            </div>
